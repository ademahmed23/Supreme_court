...
<head>
    ...
    <title>Media Management &mdash; HMM</title>

    <!-- General CSS Files -->
    <link rel="stylesheet" href="{{ asset('admin/assets/modules/bootstrap/css/bootstrap.min.css') }}">
    <link rel="stylesheet" href="{{ asset('admin/assets/modules/fontawesome/css/all.min.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('admin/assets/css/plugins.css') }}">
    {{-- <link href="{{ mix('admin/assets/css/full-screen.css') }}" rel="stylesheet" type="text/css"/> --}}
...
@php
    $unReadMessages = \App\Models\RecivedMail::where('seen', 1)->count();
@endphp
<body>
    <div id="app">
